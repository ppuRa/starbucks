...
// 유튜브 위 이이미 추가 애니메이션 효과
// gsap 애니메이션 요소, 지연, Y축 움직이는 범위
function floatingObject1(selector,delay,size){
  // gsap.to(요소, 지속시간, 옵션)
  gsap.to(selector,1,{
    y:20,
...
function floatingObject2(selector,delay,size){
  // gsap.to(요소, 지속시간, 옵션)
  gsap.to(selector,1,{
    y:20,
    // 무한 반복, 자바스크립트에서 지원하는 동작
...
function floatingObject3(selector,delay,size){
  // gsap.to(요소, 지속시간, 옵션)
  gsap.to(selector,1,{
    y:20,
    // 무한 반복, 자바스크립트에서 지원하는 동작
...
floatingObject1('img.floating1', 1, 15);
floatingObject2('img.floating2', 5, 15);
floatingObject3('img.floating3', 1.5, 20);
